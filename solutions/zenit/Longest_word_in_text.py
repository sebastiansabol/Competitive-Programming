...
text = """Raz dávno v krajine kódu, v meste Algoria, žil šikovný programátor menom Alan. Alan bol obľúbený v celej Algorii pre svoje zručnosti a múdrosť v kóde. Jedného dňa, keď Alana navštívil tajomný robot s menom Robi, zistil o záhadnej úlohe, ktorá ho čakala.
